...
<body>
	...
	<form action="login.php" method="post" id="login_formulario">
		...
		<div>
		<input class="campo"  placeholder="Contraseña" type="password" oninput="passwordValidation()" name="passUsuario" id="passUsuario" value="<?php echo isset($passUsuario)?$passUsuario:'';?>" required/>
		</div>
		<div id="boton">
	...
	<a href="http://localhost:8000/api/documentation">Interfaz-Swagger</a>
	</div>
	</div>
